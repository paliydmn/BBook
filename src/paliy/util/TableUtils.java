...
import paliy.controller.tabs.ImportBooksController;
...
public class TableUtils {
    ...
    public static void pasteFromClipboard( TableView<?> table) {
        ...
        //if table empty we will create .countTokens() rows for pasting data
        ImportBooksController.setData(rowTokenizer.countTokens());
